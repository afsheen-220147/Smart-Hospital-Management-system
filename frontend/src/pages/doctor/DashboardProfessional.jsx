 ...
 * 
 * File: frontend/src/pages/doctor/DashboardProfessional.jsx
 * 
 * Features:
 * - Enterprise-grade professional UI
 * - Consistent with Patient Dashboard design system
 * - Doctor info with status tracking
 * - Session-based appointment filtering
 * - Clean table layout
 * - Minimal, professional styling (no emojis, no orange buttons)
 */
...
export default function DoctorDashboard() {
  ...
  // ============================================
  // EFFECT: Fetch doctor profile & appointments
  // ============================================
